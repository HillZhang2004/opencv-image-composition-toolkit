...
Small OpenCV utility for compositing RGBA elements onto RGB backgrounds using alpha blending, with normalized placement and boundary safe clipping. Built as part of a computer vision assignment to practice image formation and masking.

## What it does
- Crops an element to the minimal nonzero alpha bounding box
- Resizes the element so the bounding box height matches a normalized target height (aspect ratio preserved)
